(("CarSetup"
  ...
  Drive
  (":-D"
   FrontDiffMaxTorque				105.0
   CenterDiffMaxTorque				0.0
   RearDiffMaxTorque				0.0

   MaxBrakePressureFront			4940000
   MaxBrakePressureRear				2930000
   HandbrakePercentage_NGP			0.62
   ...
   BumpStopStiffnessFront_NGP		380000
   BumpStopDampingBumpFront_NGP		24500
   BumpStopDampingReboundFront_NGP	27000

   BumpStopStiffnessRear_NGP		225000
   BumpStopDampingBumpRear_NGP		14000
   BumpStopDampingReboundRear_NGP	16000
   )
  Engine
  (":-D"
   Features_NGP						0
  ...
  (":-D"
   TopMountSlot						3
   SteeringRodLength				+0.347980
   StrutPlatformHeight				0.025000
   WheelAxisInclination				-0.071733
   )
  ...
  (":-D"
   TopMountSlot						0
   SteeringRodLength				+1.190000
   StrutPlatformHeight				0.025000
   WheelAxisInclination				-0.027053
   )
  ...
  (":-D"
   SpringLength						0.255
   SpringStiffness					26800
   HelperSpringMinLength			0.028
   HelperSpringLength				0.070
   HelperSpringStiffness			20100
   DampingBump						3180
   DampingRebound					3660
   BumpHighSpeedBreak				0.30
   DampingBumpHighSpeed				2440
   )
