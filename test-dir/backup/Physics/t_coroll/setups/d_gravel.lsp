(("CarSetup"
  ...
  (":-D"
   ...
   MaxBrakePressureFront			3660000
   MaxBrakePressureRear				2710000
  ...
  (":-D"
   TopMountSlot						3
   SteeringRodLength				+0.333640
   StrutPlatformHeight				0.030000
   WheelAxisInclination				-0.088663
   )
  ...
  (":-D"
   TopMountSlot						0
   SteeringRodLength				+1.230000
   StrutPlatformHeight				0.030000
   WheelAxisInclination				-0.032482
   )
  ...
  (":-D"
   ...
   HelperSpringMinLength			0.0
   HelperSpringLength				0.0
   HelperSpringStiffness			0.0
   DampingBump						2900
   DampingRebound					3120
