(("CarSetup"
  Car
  ("Car"
   MaxSteeringLock					1.20
   FrontRollBarStiffness			6000
   RearRollBarStiffness				9000
   )
  Drive
  (":-D"
   FrontDiffMaxTorque				0.0
   CenterDiffMaxTorque				0.0
   RearDiffMaxTorque				0.0

   MaxBrakePressureFront			5580000
   MaxBrakePressureRear				3850000
   HandbrakePercentage_NGP			0.77
  ...
  (":-D"
   TopMountSlot						3
   SteeringRodLength				+0.329990
   StrutPlatformHeight				0.030000
   WheelAxisInclination				-0.078152
   )
  ...
  (":-D"
   TopMountSlot						0
   SteeringRodLength				+0.320000
   StrutPlatformHeight				0.030000
   WheelAxisInclination				-0.012876
   )
  ...
  (":-D"
   ...
   DampingBump						4970
   DampingRebound					5350
   BumpHighSpeedBreak				0.0
   DampingBumpHighSpeed				0.0
   )
  ...
  (":-D"
   SpringLength						0.260
   SpringStiffness					32400
   HelperSpringMinLength			0.034
   HelperSpringLength				0.085
   HelperSpringStiffness			24300
   DampingBump						4220
   DampingRebound					4540
   BumpHighSpeedBreak				0.0
   DampingBumpHighSpeed				0.0
