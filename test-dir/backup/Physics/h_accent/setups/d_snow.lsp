(("CarSetup"
  ...
  (":-D"
   ...
   MaxBrakePressureFront			4910000
   MaxBrakePressureRear				2560000
   HandbrakePercentage_NGP			0.87
   ...
   HighSpeedDampingReboundFront_NGP 3740

   HighSpeedBreakReboundRear_NGP	0.30
   HighSpeedDampingReboundRear_NGP	3740
  ...
  (":-D"
   SpringLength						0.305
   SpringStiffness					27600
   HelperSpringMinLength			0.054
   HelperSpringLength				0.135
   HelperSpringStiffness			20700
   DampingBump						4050
   DampingRebound					4360
   BumpHighSpeedBreak				0.30
   DampingBumpHighSpeed				3110
   )
