(("CarSetup"
  ...
  ("Car"
   ...
   FrontRollBarStiffness			15000
   RearRollBarStiffness				15500
   )
  Drive
  (":-D"
   FrontDiffMaxTorque				90.0
   CenterDiffMaxTorque				0.0
   RearDiffMaxTorque				150.0

   MaxBrakePressureFront			6260000
   MaxBrakePressureRear				2260000
   HandbrakePercentage_NGP			1.0
   ...
   HighSpeedDampingReboundFront_NGP 5060

   HighSpeedBreakReboundRear_NGP	0.30
   HighSpeedDampingReboundRear_NGP	4620

   BumpStopStiffnessFront_NGP		190000
   BumpStopDampingBumpFront_NGP		16500
   BumpStopDampingReboundFront_NGP	18000

   BumpStopStiffnessRear_NGP		190000
   BumpStopDampingBumpRear_NGP		16500
   BumpStopDampingReboundRear_NGP	18000
   )
  Engine
  (":-D"
   Features_NGP						1
  ...
  (":-D"
   TopMountSlot						3
   SteeringRodLength				+0.455270
   StrutPlatformHeight				0.005000
   WheelAxisInclination				-0.070069
   )
  ...
  (":-D"
   SpringLength						0.225
   SpringStiffness					50800
   HelperSpringMinLength			0.032
   HelperSpringLength				0.080
   HelperSpringStiffness			38100
   DampingBump						5480
   DampingRebound					5900
   BumpHighSpeedBreak				0.30
   DampingBumpHighSpeed				4210
   )
  ...
  (":-D"
   SpringLength						0.225
   SpringStiffness					42400
   HelperSpringMinLength			0.046
   HelperSpringLength				0.115
   HelperSpringStiffness			31800
   DampingBump						5010
   DampingRebound					5390
   BumpHighSpeedBreak				0.30
   DampingBumpHighSpeed				3850
   )
