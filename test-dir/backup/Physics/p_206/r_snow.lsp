(("(null)"
  ...
  ("(null)"
   ...
   vecTopMount00					+0.586	-2.441	+0.790
   vecTopMount01					+0.584	-2.439	+0.790
   vecTopMount02					+0.582	-2.437	+0.790
   vecTopMount03					+0.580	-2.435	+0.790
   vecTopMount04					+0.578	-2.433	+0.790
   vecTopMount05					+0.576	-2.431	+0.790
   vecTopMount06					+0.574	-2.429	+0.790
   vecTopMount07					+0.572	-2.427	+0.790
   ...
   ;vecSteeringMount_VF				+0.312	-2.365	+0.235		; LF (lock)
  ...
  ("(null)"
   ...
   ;vecSteeringMount_VF				-0.228	-2.365	+0.235		; RF (lock)
