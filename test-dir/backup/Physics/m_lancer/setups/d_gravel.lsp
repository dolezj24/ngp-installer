(("CarSetup"
  ...
  ("Car"
   ...
   FrontRollBarStiffness			9000
   RearRollBarStiffness				7000
   )
  Drive
  (":-D"
   ...
   MaxBrakePressureFront			4610000
   MaxBrakePressureRear				2160000
   HandbrakePercentage_NGP			0.56
  ...
  (":-D"
   TopMountSlot						3
   SteeringRodLength				+0.455670
   StrutPlatformHeight				0.015000
   WheelAxisInclination				-0.079915
   )
  ...
  (":-D"
   SpringLength						0.295
   SpringStiffness					26000
   HelperSpringMinLength			0.058
   HelperSpringLength				0.145
   HelperSpringStiffness			19500
   DampingBump						3780
   DampingRebound					4070
   BumpHighSpeedBreak				0.30
   DampingBumpHighSpeed				2910
   )
